                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <input type="text" name="flat_no" placeholder="Enter your flat no"> 
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Building Number</th>
                                                        <th class="border-0">Flat Number</th>
                                                        <th class="border-0">Rent Amount</th>
                                                        <th class="border-0">Receipt Number</th>
                                                ...
                                                @foreach($rent as $rent)
                                                    <tr>
                                                        ...
                                                        <td>{{$rent->building_no}}</td>
                                                        <td>{{$rent->flat_no}} </td>
                                                        <td>{{$rent->rent_amount}} </td>
                                                        <td>{{$rent->receipt_no}} </td>
                                                        <td>{{$rent->months}} </td>
